 ...
 *
 * Solution O(N ^ 2) Recursively solve each substring within round braces as subformula. Consider each subformula as
 * right subformula and each each subformula before the round braces as left subformula - sum up value of both left
 * and right subformula to get the answer.
 */
