 ...
 * same coloured balls which exceeds the count of 3 starting from index i = 0. Each new string formed (by adding a
 * new ball to a position i) makes a new state. Backtrack and traverse the search space and keep track of count of
 * balls used. Maintain a minimum count variable and return that as the answer.
 */
