 ...
 *
 * Solution: O(E log N) E is the length of edges and N is the number of nodes. The n nodes on a edge form a weight
                ...
                for(Node c : children){
                    if(!distance.containsKey(c.n)){
                        ...
                        if(unvisitedNodes > 0){
                            ...
                            count += (unvisitedNodes >= availableMovesForCurr ? availableMovesForCurr : unvisitedNodes);
                        }
                    }
                }
            }
