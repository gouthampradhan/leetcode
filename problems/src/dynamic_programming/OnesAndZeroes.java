 ...
 *
 * Solution: O(S x m x n) For every string array position we have two choices i. pick this value or ii.
 * not pick this value. Evaluate both these cases and cache the result in a dp array.
 */
