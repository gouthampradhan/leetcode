 ...
 *
 * Solution:
 * O(N log N) where N is the size of Capital/Profit array.
 * General intuition is to pick a project which gives maximum profit for the available capital. Sum the
 * profit with the original capital and this becomes the new available capital now, again pick the
 * project which gives maximum profit. Continue this until K projects are picked. Maintain a priority queue
 * to pick the project which gives maximum profit.
 */
import java.util.*;
public class IPO {
