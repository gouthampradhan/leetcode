 ...
 *
 * Solution: O(N x N)
 * Select each row and greedily flip the row if it maximizes the value.
 * Select each column and flip the column if the count of 1's in the column is smaller than count
 * of 0's
